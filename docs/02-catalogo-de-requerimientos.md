...
| RQ-FED-009 | **Dominio institucional único y sus subdominios** (portal, consola, prototipos) y responsable del DNS. Regla de Cenisoft: todo Fedesoft y Cenisoft bajo un solo dominio, sin mezclar | Comunicaciones + Cenisoft | S2 | Despliegue en preproducción y cualquier demostración externa | Se usa una URL provisional del proveedor, marcada como temporal y no compartida fuera del equipo |
